...
process_commits() {
  ...
  # Use the appropriate repo list based on the category
  ...
  # Loop through each repo in the selected list
  while IFS= read -r repo; do
    # Retrieve the language for each repository from repos.txt
